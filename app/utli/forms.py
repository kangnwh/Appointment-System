...
from wtforms import PasswordField, StringField, IntegerField, DateField, SelectField, SelectMultipleField, BooleanField, \
    FloatField
...
class ReminderForm(Form):
    reminder_period = FloatField("Reminder Before(hours)", validators=[DataRequired()])
    via_email = BooleanField("Email Reminder?")
    via_message = BooleanField("Phone Message Reminder?")
